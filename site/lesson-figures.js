...
(function () {
  ...
  function ensureStyles() {
    ...
    s.id = 'lf-styles';
    s.textContent = [
      '.lf{border:1px solid var(--rule-soft,#ddd);background:var(--bg,#ffffff);margin:28px 0;padding:0;font-family:var(--font-body,serif)}',
      '.lf-head{display:flex;justify-content:space-between;align-items:baseline;gap:12px;padding:12px 16px;border-bottom:1px solid var(--rule-soft,#ddd);font-family:var(--font-mono,sans-serif);font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-mute,#777)}',
      '.lf-head .lf-label{color:var(--blueprint,#05164d)}',
      ...
      '.lf-ctrl label{font-family:var(--font-mono,sans-serif);font-size:.7rem;letter-spacing:.08em;text-transform:uppercase;color:var(--ink-soft,#555);display:flex;justify-content:space-between}',
      '.lf-ctrl label b{color:var(--blueprint,#05164d);font-variant-numeric:tabular-nums}',
      '.lf-ctrl input[type=range]{width:100%;accent-color:var(--blueprint,#05164d)}',
      '.lf-ctrl select{font-family:var(--font-mono,sans-serif);font-size:.82rem;padding:4px 6px;background:var(--bg,#ffffff);color:var(--ink,#0f172a);border:1px solid var(--rule-soft,#ddd)}',
      '.lf-out{margin-top:18px;padding-top:14px;border-top:1px dashed var(--rule-soft,#ddd)}',
      '.lf-num{font-family:var(--font-mono,sans-serif);font-size:2rem;color:var(--blueprint,#05164d);font-variant-numeric:tabular-nums;line-height:1}',
      ...
      '.lf-bar i{position:absolute;inset:0 auto 0 0;width:0;background:var(--blueprint,#05164d);transition:width .12s ease}',
      '.lf-bar.over i{background:var(--warn,#8f7231)}',
      '.lf-meta{font-family:var(--font-mono,sans-serif);font-size:.7rem;color:var(--ink-mute,#777);margin-top:8px;letter-spacing:.04em}',
      '.lf-formula{font-family:var(--font-mono,sans-serif);font-size:.72rem;color:var(--ink-soft,#555);margin-top:6px;word-break:break-word}',
      ...
      '.lesson-figure.lf-animated{border:1px solid var(--rule-soft,#ddd);background:var(--bg,#ffffff);margin:28px 0;padding:14px}',
      '.lesson-figure.lf-animated svg{display:block;width:100%;height:auto;max-width:760px;margin:0 auto;color:var(--blueprint,#05164d)}'
    ].join('\n');
