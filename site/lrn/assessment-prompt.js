...
(function (root) {
  ...
  function render() {
    ...
    root.document.querySelectorAll("[data-assessment-prompt]").forEach(function (host) {
      ...
      var heading = element("h2", model.assessmentAvailable ? (de ? "AI Self-Assessment erneut durchführen" : "Retake the AI self-assessment") : (de ? "Finde deinen Einstieg mit dem AI Self-Assessment" : "Find your starting point with the AI self-assessment"));
      ...
      var start = element("a", model.assessmentAvailable ? (de ? "Assessment wiederholen" : "Retake assessment") : (de ? "Assessment starten" : "Start assessment"), "readiness-button");
