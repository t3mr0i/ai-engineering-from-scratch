(function (root) {
  ...
  var COPY = {
    en: {
      ...
      title: "Your training steps",
      courseEvidence: "Course contributions in detail",
      moreTools: "Adapt your learning plan",
      toolsIntro: "Complete the self-assessment for recommendations based on your current level, or explore a learning path for your role.",
      role: "Role",
      ...
      targetImported: "Target from your self-assessment",
      targetChanged: "Your self-assessment uses a different target for this role. It is shown here without changing the reference target.",
      next: "Your next step",
      assessment: "Start the self-assessment",
      assessmentReason: "Answer ten questions here to find your starting point and the right next course.",
      plan: "View your training steps",
      ...
      sourceImport: "From your self-assessment",
      sourceSelf: "From your self-assessment",
      ...
      noCourse: "Your next course will appear here once your training steps are ready.",
      blockedReason: "Some training steps are still preparatory or unavailable. Open your plan to review them.",
      ...
      academyTtt: "After completing these training steps, the LHIND Academy can advise on suitable Train-the-Trainer formats.",
      assessmentPanel: "Self-assessment",
    ...
    de: {
      ...
      title: "Deine Trainingsschritte",
      courseEvidence: "Kursbeiträge im Detail",
      moreTools: "Lernplan anpassen",
      toolsIntro: "Beantworte das Self-Assessment für Empfehlungen passend zu deinem Vorwissen oder erkunde einen Lernpfad für deine Rolle.",
      role: "Rolle",
      ...
      targetImported: "Zielbild aus deinem Self-Assessment",
      targetChanged: "Dein Self-Assessment nutzt für diese Rolle ein abweichendes Ziel. Es wird hier sichtbar gemacht, ohne das Referenz-Zielbild zu ändern.",
      next: "Dein nächster Schritt",
      assessment: "Self-Assessment starten",
      assessmentReason: "Beantworte zehn Fragen hier im Lernkatalog, um deinen Ausgangspunkt und den passenden nächsten Kurs zu finden.",
      plan: "Deine Trainingsschritte ansehen",
      ...
      sourceImport: "Aus deinem Self-Assessment",
      sourceSelf: "Aus deinem Self-Assessment",
      ...
      noCourse: "Sobald deine Trainingsschritte bereit sind, erscheint hier dein nächster Kurs.",
      blockedReason: "Einige Trainingsschritte sind noch in Vorbereitung oder nicht verfügbar. Prüfe sie in deinem Plan.",
      ...
      academyTtt: "Nach Abschluss dieser Trainingsschritte kann die LHIND Academy zu passenden Train-the-Trainer-Formaten beraten.",
      assessmentPanel: "Self-Assessment",
  ...
  function render(host, options) {
    ...
    if (!model) {
      host.appendChild(el("p", "journey-ui__loading", language() === "de" ? "Deine Trainingsschritte werden vorbereitet …" : "Preparing your training steps …"));
      return;
    }
