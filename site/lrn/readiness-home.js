...
(function (root) {
  ...
  var COPY = {
    en: {
      ...
      importWhy: "Where are you starting from?", importWhyIntro: "Answer ten questions to assess where you stand in AI Literacy. Then find training that fits your role.",
      ...
      startAssessment: "Start the AI Self Assessment", retakeAssessment: "Retake the AI Self Assessment",
      startAssessmentV2: "Start the AI Self Assessment V2",
      confirmRole: "Continue to your role", skipAssessment: "Continue without an assessment", browse: "Explore all courses", back: "Back",
    ...
    de: {
      ...
      importWhy: "Wo stehst du gerade?", importWhyIntro: "Beantworte zehn Fragen und schätze deinen Stand in AI Literacy ein. Danach findest du Trainings, die zu deiner Rolle passen.",
      ...
      startAssessment: "AI Self Assessment starten", retakeAssessment: "AI Self Assessment wiederholen",
      startAssessmentV2: "AI Self Assessment V2 starten",
      confirmRole: "Weiter zu deiner Rolle", skipAssessment: "Ohne Assessment weitermachen", browse: "Alle Kurse entdecken", back: "Zurück",
