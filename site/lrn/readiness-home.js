...
(function (root) {
  ...
  var COPY = {
    en: {
      ...
      importWhy: "Let’s build on what you know", importWhyIntro: "Answer ten questions to find courses that build on your experience. You can also start exploring first.",
    ...
    de: {
      ...
      importWhy: "Auf deinem Wissen bauen wir auf", importWhyIntro: "Beantworte zehn Fragen, damit wir Kurse finden, die an deine Erfahrung anknüpfen. Du kannst dich auch erst einmal umsehen.",
