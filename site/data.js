...
// Last built: 2026-09-08T17:08:45.262Z
    ...
    "lessons": [
      {
        ...
        "summary": "Make the toolchain observable before the first model is imported."
      },
      {
        ...
        "summary": "Use small, inspectable commits to make experiments reversible."
      },
      {
        ...
        "summary": "Measure the device you have before choosing the device you need."
      },
      {
        "name": "APIs & Keys",
        "status": "complete",
        ...
        "summary": "Make authentication, request shape, and response shape separately observable."
      },
      {
        ...
        "summary": "A notebook is a stateful experiment: make the state, output, and restart boundary visible."
      },
      {
        ...
        "summary": "Reproducibility starts with knowing which interpreter is executing the command."
      },
      {
        "name": "Docker for AI",
        "status": "complete",
        ...
        "summary": "Treat an image and its mounts as a configuration to inspect, not a promise that a host can run it."
      },
      {
        "name": "Editor Setup",
        "status": "complete",
        ...
        "summary": "A useful editor makes the project contract visible without changing the project for you."
      },
      {
        ...
        "summary": "Make dataset identity, format, split, and cache decisions reproducible before training starts."
      },
      {
        "name": "Terminal & Shell",
        "status": "complete",
        ...
        "summary": "Turn recurring training operations into inspectable shell commands, not opaque habits."
      },
      {
        "name": "Linux for AI",
        "status": "complete",
        ...
        "summary": "Operate a remote Linux box by checking paths, permissions, processes, and disk before changing anything."
      },
      {
        ...
        "summary": "Catch a bad tensor, gradient, device, or allocation before a long training run hides it."
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summary": "Read a vector as a direction, a matrix as a transformation, and a neural-network layer as their composition."
      },
      {
        ...
        "summary": "Shape rules turn `W @ x + b` from a mysterious line into a checkable forward pass."
      },
      {
        ...
        "summary": "A transformation is a rule for moving every point; its matrix makes the rule executable."
      },
      {
        ...
        "summary": "Derivatives turn a loss value into a direction an optimizer can use."
      },
      {
        ...
        "summary": "Reverse-mode autodiff is the chain rule organized around one scalar output."
      },
      {
        ...
        "summary": "A model's uncertainty becomes useful only when the probability calculation is inspectable."
      },
      {
        ...
        "summary": "Bayes' theorem turns a prior belief and observed evidence into a posterior you can audit."
      },
      {
        ...
        "summary": "An optimizer is a stateful rule for turning a gradient into the next parameter vector."
      },
      {
        ...
        "summary": "Turn probability tables into measurable uncertainty, mismatch, and model loss."
      },
      {
        ...
        "summary": "Compress a structured matrix while keeping the variance and geometry you can defend."
      },
      {
        ...
        "summary": "Factor a matrix into input rotation, scaling, and output rotation—and know what the factors buy you."
      },
      {
        ...
        "summary": "Make shape, stride, contraction, and attention invariants visible before a framework hides them."
      },
      {
        ...
        "summary": "Treat overflow, cancellation, and finite precision as explicit failure modes in the training loop."
      },
      {
        ...
        "summary": "Choose a distance by the invariants your retrieval or comparison task actually needs."
      },
      {
        ...
        "summary": "Separate uncertainty, evidence, and practical impact before changing a model."
      },
      {
        ...
        "summary": "Turn simple random draws into controlled estimates, chains, and token candidates."
      },
      {
        "name": "Linear Systems",
        "status": "complete",
        ...
        "summary": "Solve `Ax=b` reliably, then reuse the factorization when the right-hand side changes."
      },
      {
        ...
        "summary": "Convexity gives a global statement about local search; the code makes that statement testable on small fixtures."
      },
      {
        ...
        "summary": "Complex multiplication is a compact language for rotations, phases, and Fourier coefficients."
      },
      {
        ...
        "summary": "Move a signal from samples to frequencies, then return to the samples without hiding the normalization."
      },
      {
        ...
        "summary": "The same adjacency structure powers traversal, spectral clustering, message passing, and ranking."
      },
      {
        ...
        "summary": "Randomness gains structure when a state, transition rule, and time index are made explicit."
      },
      {
        ...
        "summary": "A Gaussian process predicts a value and exposes how much the kernel assumptions still leave uncertain."
      }
    ],
    "hidden": true
  },
    ...
    "lessons": [
      {
        ...
        "summary": "Turn a small, labeled table into a prediction, then measure what the model did not see."
      },
      {
        ...
        "summary": "Fit a line twice: once by repeated gradients and once by solving the least-squares geometry directly."
      },
      {
        ...
        "summary": "Turn a linear score into a bounded probability, then choose a threshold that matches the cost of mistakes."
      },
      {
        ...
        "summary": "A split is useful only when its weighted child impurity is lower than the parent impurity."
      },
      {
        ...
        "summary": "Find a separating hyperplane while keeping the nearest correctly classified points at a margin."
      },
      {
        ...
        "summary": "KNN does not compress the training table: it answers a query by measuring its nearest stored rows."
      },
      {
        ...
        "summary": "When labels are absent, cluster quality and density assumptions become part of the model contract."
      },
      {
        ...
        "summary": "Turn raw numbers, categories, and short documents into features a model can inspect without leaking the target."
      },
      {
        ...
        "summary": "A score is useful only when the split, metric, and comparison match the decision you need to make."
      },
      {
        ...
        "summary": "Repeated fits reveal whether error comes from a rigid model, an unstable model, or the data itself."
      },
      {
        ...
        "summary": "Combine intentionally different mistakes: boosting changes the data emphasis, bagging averages resampled trees, and stacking learns a second-stage vote."
      },
      {
        ...
        "summary": "Search is an experiment budget: define the space, score on validation data, and keep the test set for the final choice."
      },
      {
        ...
        "summary": "Fit preprocessing once on training rows, then carry the learned state unchanged into inference."
      },
      {
        "name": "Naive Bayes",
        "status": "complete",
        ...
        "summary": "A strong conditional-independence assumption can be a useful bias when the evidence is sparse and high-dimensional."
      },
      {
        ...
        "summary": "Time order is part of the data: a useful forecast only uses information available at its timestamp."
      },
      {
        ...
        "summary": "An anomaly score is a screening signal; the response policy still needs context and review."
      },
      {
        ...
        "summary": "A 99% accuracy score can hide every positive error when the event of interest is rare."
      },
      {
        ...
        "summary": "A selected feature is evidence from a training procedure, not a permission to inspect the test set."
      },
      {
        ...
        "summary": "A recommender ranks uncertain, selectively observed feedback; an empty cell is not automatically a dislike."
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summary": "A single threshold unit makes the update rule visible: a wrong class moves one boundary."
      },
      {
        ...
        "summary": "A dense layer is a shape-preserving contract wrapped around an affine map and a nonlinearity."
      },
      {
        ...
        "summary": "Reverse-mode autodiff is the chain rule plus a topological traversal of a scalar computation graph."
      },
      {
        ...
        "summary": "The activation decides both the signal a layer emits and the local derivative backpropagation sees."
      },
      {
        ...
        "summary": "A loss turns a prediction into a scalar training signal; its domain and reduction are part of the API."
      },
      {
        ...
        "summary": "Optimizers turn a gradient into a parameter step while carrying carefully defined state between steps."
      },
      {
        ...
        "summary": "Regularization changes the training objective or representation so memorizing the training set is less attractive."
      },
      {
        ...
        "summary": "The first forward pass already reveals whether a network's scale is plausible."
      },
      {
        ...
        "summary": "A schedule is a time-indexed function; its endpoint and boundary rules are part of the training contract."
      },
      {
        ...
        "summary": "A framework is a small set of contracts that lets layers, losses, data, and updates compose."
      },
      {
        ...
        "summary": "The familiar module loop becomes a tensor program only after the shapes, dtype, device, and gradient boundaries are explicit."
      },
      {
        ...
        "summary": "Learn the data-flow ideas behind `grad`, `vmap`, and explicit PRNG keys with a runnable standard-library bridge.",
        "keywords": "1. Inspect the parameter contract · 2. Approximate and map · 3. Train the local fixture"
      },
      {
        ...
        "summary": "Turn a plausible-looking loss curve into a small, reproducible report about finiteness, activations, gradients, and derivatives.",
        "keywords": "1. Check finiteness first · 2. Classify the loss trace · 3. Inspect activations and gradients · 4. Check one derivative"
      }
    ],
    "hidden": true
  },
    ...
    "lessons": [
      {
        ...
        "summary": "A vision model only sees the numeric tensor that arrives at its first layer."
      },
      {
        ...
        "summary": "A convolutional layer is a shared dot product over local image neighborhoods."
      },
      {
        ...
        "summary": "Architecture names are useful only when their tensor transitions and skip contracts are explicit."
      },
      {
        ...
        "summary": "A classifier is a chain of data contracts, not just a final `argmax`."
      },
      {
        ...
        "summary": "Transfer learning is a parameter-ownership decision before it is an optimizer decision."
      },
      {
        ...
        "summary": "Detection turns a dense grid of raw numbers into a short list of boxes, scores, and classes."
      },
      {
        ...
        "summary": "Semantic segmentation assigns a class to every pixel, so shape and metric contracts are part of the model."
      },
      {
        ...
        "summary": "An instance mask is useful only when its pixels stay aligned with the box that selected them."
      },
      {
        ...
        "summary": "A GAN is a coupled game: the discriminator learns a test while the generator learns to pass it."
      },
      {
        ...
        "summary": "A sampler is a sequence of indexed equations; the timestep contract matters as much as the neural network."
      },
      {
        ...
        "summary": "A diffusion pipeline is a set of contracts between text, latent, denoiser, scheduler, and safety components."
      },
      {
        ...
        "summary": "A video model sees a sequence; a careless split or sampler can erase that sequence before the model starts."
      },
      {
        ...
        "summary": "A radiance field becomes an image only after densities are accumulated along camera rays."
      },
      {
        ...
        "summary": "Make the image-to-sequence conversion visible before discussing a larger model."
      },
      {
        ...
        "summary": "A latency number is useful only when its warmup, input shape, device, and tail percentile are recorded with it."
      },
      {
        ...
        "summary": "A pipeline is a sequence of contracts: pixels become a tensor, boxes become crops, and predictions become validated JSON."
      },
      {
        ...
        "summary": "The pretext signal changes, but the engineering question stays concrete: what tensor is the target, and what state is updated?"
      },
      {
        ...
        "summary": "A two-tower model turns a list of text prompts into a candidate set; the score is only meaningful if both sides share a normalized space."
      },
      {
        ...
        "summary": "Recognition, layout, and meaning are different contracts; CTC only solves the line-recognition alignment problem."
      },
      {
        ...
        "summary": "Retrieval quality starts with a relevance definition, then makes the distance function obey it."
      },
      {
        ...
        "summary": "A heatmap makes a coordinate prediction spatial: the peak is the joint, and the target construction is part of the contract."
      },
      {
        ...
        "summary": "Turn one 3-D Gaussian into a camera-space ellipse, then composite a few ellipses into an image."
      },
      {
        ...
        "summary": "Make patch tokens and a straight probability-flow path explicit before choosing a transformer."
      },
      {
        ...
        "summary": "Keep a text prompt, instance mask, box, and score aligned even when the detector is a stub."
      },
      {
        ...
        "summary": "Make the bridge from visual patch features to language-space decisions measurable before using a VLM."
      },
      {
        ...
        "summary": "Separate scale-sensitive depth metrics from the pinhole geometry used to export a point cloud."
      },
      {
        ...
        "summary": "Match detections to tracks, age missing objects, and measure identity continuity with explicit rules."
      },
      {
        ...
        "summary": "Make video patch geometry, attention cost, and a small action-conditioned rollout inspectable."
      }
    ],
    "hidden": true
  },
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "Zero-Shot vs Few-Shot: When Examples Beat Instructions · Example Selection: Similar Beats Random · Chain-of-Thought: Giving Models Scratch Paper · Self-Consistency: Sample Many, Vote Once · Tree-of-Thought: Branching Exploration · ReAct: Thinking + Doing · Structured Prompting: XML Tags, Delimiters, Headers · Prompt Chaining: Sequential Decomposition · Performance Comparison · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The handshake · What MCP is not · Destructive Tools and Approval · The Agentic Loop in Practice · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The four superpowers · Reducers are the point · The ReAct graph in four nodes · StateGraph vs Send (fanout) · Subgraphs · Step 1: state and nodes · Step 2: run with a thread · Step 3: add a human-in-the-loop interrupt · Step 4: time-travel for debugging · Step 5: swap the checkpointer for production · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Signals to Look For · Controls to Teach · Target Roles · Workshop Flow · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Signals to Look For · Controls to Teach · Target Roles · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The capability ladder · Context is the product · Code review and the PR loop · Copilot vs Cursor vs Claude Code · What stays your job · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "Two surfaces, opposite directions · What makes a PR reviewable · Reading the coding agent's PR · What Copilot code review owns — and does not · Tuning signal vs noise · Where this sits relative to the reviewer agent · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The convergence · Where they differ — the \"where you live\" axis · What does *not* transfer (so you pick deliberately) · MCP in the IDE — the real leverage · The trust boundary MCP introduces · How to actually choose · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four layers, the way a consultant draws them on a whiteboard · Failure story: the CRM RAG at a logistics firm · Current model landscape (mid-2026) · Failure story: the contract reviewer at an insurer · What generative models can and cannot do (the practitioner version) · Agentic AI: where the risk profile shifts · Failure story: the prompt workshop at a public-sector team · Responsible AI: from principle to obligation · The three questions a consultant must answer first · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "What it cost, and what the fix cost · The two gates · GDPR in the context window, concretely · AI Act high-risk classification — the use case decides · The proxy-bias audit · Human oversight as an engineering requirement · Numbers and tradeoffs in practice · How the three gates compose · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The five-layer prompt anatomy · Output contracts · Pattern taxonomy · Iterative refinement as an engineering loop · Model-specific considerations in 2026 · What makes a prompt maintainable · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The five-layer reference model · Context assembly: the highest-leverage layer · Orchestration: when you need more than one call · Tool execution and trust boundaries · Deployment topology: where computation happens · Observability: the layer most teams skip · The architecture selection heuristic · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The canonical agent loop · Task decomposition patterns · Tool design is architecture · Verification gates and blast radius · Grounding and the confabulation trap · 2026 framework landscape · What makes a professional-grade agentic system · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The three regulatory clocks every AI project faces · Risk classification: the EU AI Act pyramid · GDPR triggers that the AI Act does not cover · Internal policy controls: the three gates · The intake checklist in practice · Current model landscape and compliance implications · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The three evaluation layers · Eval set design · LLM-as-judge scoring · Regression gates · QA gate placement in the delivery pipeline · Current toolset (2026) · What evals cannot replace · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four-pass audit protocol · Scoring a legacy module before you slice it · Slice sizing and the review obligation · Using current models effectively · What the model cannot substitute for · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four documentation types and their grounding requirements · The source-grounding discipline · Handoff documentation: the specific case · AI models as documentation drafters in 2026 · Tooling patterns for source injection · Accountability and review obligations · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four levers of AI system emissions · Serving region and grid carbon intensity · Model tier selection · Prompt efficiency · Caching and call volume · Cross-linking to the rest of the course · The SCI formula in practice · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The cost stack · Model tiers and the right-sizing decision · Cache economics in detail · The value denominator · Total cost of ownership beyond token spend · FinOps practices for LLM systems · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four-layer consulting prompt · Hypothesis-first prompting · Stakeholder encoding · Output contracts · Iterative hypothesis refinement · Where consultative prompting fits the course · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Anatomy of a role in an AI-augmented workflow · The role-capability matrix · Sizing the gap: from matrix to backlog · From backlog to enablement measures · Operating model: who owns this? · Cross-references · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "Decisions, not outputs · Decision types and their process requirements · Metric signals a decision process must consume · The decision gateway pattern · Human-in-the-loop: meaningful vs. nominal · Uncertainty quantification in 2026 · Audit trails and the accountability chain · Connecting to sibling lessons · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The five data readiness dimensions · Quality: beyond row counts · Freshness: TTL and query lag · Sensitivity: data classification before any model touches it · Provenance and licensing · Evaluation coverage: the distribution mismatch trap · The five-dimension readiness gate · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "Five failure shapes (what you actually see in the field) · The five attack surfaces (mapped to failure shapes) · Threat triage: severity scoring · Controls by surface · The multi-agent case · Where the audit trail goes · What the 2026 threat picture looks like · Triage workflow (how to run this in an engagement) · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The wrong-doc failure shape, named · The four planning decisions, reconceived · Source readiness: the supersedure audit · Permission boundaries: provenance back to the source system · Provenance metadata: the reconstruction path · Fallback paths: the faithfulness gate · The full system decision flow · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Four incident categories · A named failure shape: \"the silent drift\" · The signal hierarchy · Runbooks · Severity, ownership, and escalation tree · Rollback controls and model versioning · Numbers worth knowing · Building the AI ops practice inside an existing SRE org · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The service AI pipeline · Ticket extraction: what to pull · Triage routing policy · Knowledge retrieval and grounding · Response quality scoring · Incident handoff structure · Where frontier models fit in 2026 · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "What a steering pack actually is · The evidence hierarchy · Prompt architecture for pack generation · The decision question discipline · Quality gates before presenting · Where current models sit · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The four inputs that determine automation readiness · The exception map in practice · Output sensitivity scoring · The automation readiness score · What \"not ready\" means · Relationship to pilot controls and HITL design · Current tooling context (2026) · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "What an AI ADR captures · Model selection as a documented trade-off · Vendor security boundaries · Cost governance as a first-class concern · The re-evaluation trigger pattern · Registering decisions across a portfolio · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four scoring dimensions · Weighted scoring: the RICE variant · Where LLMs actually help · Decision records and audit trails · Dependency graph analysis · Integrating with existing tools · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The three boundary types · IoT data: the pre-LLM processing obligation · Data platform integration: schema lineage and freshness SLAs · Latency budget decomposition · The four feasible architecture patterns · Practical decision sequence for a new use case · Recommended trainings (LHIND AI Literacy)"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The four-zone triage model · Ticket clustering and pattern identification · Runbook quality scoring · Knowledge gap identification with LLMs · Automation generation and human-in-the-loop validation · Knowledge freshness and drift detection · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four canonical LLM risk categories · Severity rating per category · Triage scoring method · The four categories in practice · When to escalate vs continue · OWASP LLM Top 10 (2025) mapping · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four governance primitives · Lifecycle states · Versioning discipline · Evaluation anchors and the regression gate · Ownership and review · Retirement rules · Cross-lesson connections · Tooling landscape in 2026 · Recommended trainings (LHIND AI Literacy)"
      },
      {
        ...
        "keywords": "The four outputs of an AI Champion · Audience triage · Piloting new AI approaches: the three-gate model · Changelog literacy: separating signal from noise · Running a community of practice that survives year two · Recommended trainings (LHIND AI Literacy)"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "Three server primitives · Three client primitives · Wire format: JSON-RPC 2.0 · Three-phase lifecycle · Capability negotiation · Structured content and error shapes · Client capabilities vs tool call details · Why JSON-RPC and not REST? · Recommended trainings (LHIND AI Literacy)"
      },
      {
