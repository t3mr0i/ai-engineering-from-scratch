...
// Last built: 2026-06-22T17:59:04.362Z
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "summary": "As of 2026, large language models power tools that more than 750 million people use weekly — yet most discussions about AI in business contexts still conflate four structurally …",
        "keywords": "Four layers of the AI landscape · Current model landscape (mid-2026) · What generative models can and cannot do · Agentic AI: where the risk profile shifts · Responsible AI: from principle to obligation · The three questions a consultant must answer first"
      },
      {
        ...
        "summary": "A 2025 McKinsey survey of knowledge workers found that AI adopters who deliberately matched tasks to tools—rather than defaulting to the first assistant they had access to—repor…",
        "keywords": "The four functional categories · Task classification before tool selection · Verification proportional to consequence · Summarization: where most practitioners underestimate the tool · Writing and ideation: where the tool earns its keep · Data handling: the decision that matters before the prompt"
      },
      {
        ...
        "summary": "The EU AI Act's high-risk classification rules took full effect in August 2026, adding binding obligations — conformity assessments, fundamental-rights impact assessments, and m…",
        "keywords": "The three-layer compliance model · GDPR in the context window · AI Act high-risk classification and what it triggers · Bias, fairness, and protected-attribute proxies · Guardrail design for responsible use · The DPIA and FRIA decision gates · Human oversight as an engineering requirement"
      },
      {
      ...
      },
      {
        ...
        "summary": "McKinsey's 2025 State of AI survey found that organizations with a structured use-case triage process reached production 2.4x faster than those that went straight from \"idea\" to…",
      ...
      },
      {
        ...
        "summary": "As of mid-2026 there are more than forty production-grade frontier-model endpoints and over a hundred agent orchestration frameworks. Anthropic's Fable 5 and Opus 4.x family, Op…",
        "keywords": "The four-layer stack · Model provider landscape and selection criteria · Managed inference platforms in detail · AI gateways: the operational layer that teams skip · Agent frameworks: choosing the right abstraction · Making the decision: a scoring approach"
      },
      {
      ...
      },
      {
        ...
        "summary": "In 2026, every major enterprise AI deployment has learned the same hard lesson: models that score well on benchmarks still fail in production, and the failure mode is almost nev…",
        "keywords": "Decision types and their process requirements · Metric signals a decision process must consume · The decision gateway pattern · Human-in-the-loop: meaningful vs. nominal · Uncertainty quantification in 2026 · Audit trails and the accountability chain · Connecting to sibling lessons"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The five attack surfaces · Threat triage: severity scoring · Controls by surface · The multi-agent case · Where the audit trail goes"
      },
      {
        ...
        "summary": "A 2025 Gartner survey found that 67 % of enterprise RAG deployments that went into production were rolled back or frozen within six months — not because retrieval quality was po…",
        "keywords": "The four planning decisions · Source readiness: the corpus audit · Permission boundaries: encoding access control in the index · Provenance metadata: what every answer must carry · Fallback paths: what the assistant does at the corpus boundary · Evaluation as a planning input, not an afterthought · The full system decision flow"
      },
      {
        ...
        "summary": "The AI vendor market bifurcated sharply in 2025-2026: a small tier of frontier labs (Anthropic, Google DeepMind, OpenAI, Meta, Mistral) compete on model capability, while a broa…",
        "keywords": "The six evaluation dimensions · Capability: what evals actually tell you · Data handling: the GDPR and EU AI Act layer · Security posture: what the reports actually say · Integration and lock-in · Economics: the three traps · Building the scorecard"
      },
      {
        ...
        "summary": "In 2026, teams running AI features in production report that the average time between a model quality regression and its detection is 47 minutes — long enough to affect thousand…",
        "keywords": "Four incident categories · The signal hierarchy · Runbooks · Severity, ownership, and escalation tree · Rollback controls and model versioning · Building the AI ops practice inside an existing SRE org"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Consequence levels and the ownership map · The four required control elements · Where the standards converge · Model selection and risk level · Policy exceptions: the audit trap · Reading an audit evidence package"
      },
      {
