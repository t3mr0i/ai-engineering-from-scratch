...
// Last built: 2026-07-23T10:00:09.626Z
...
const PHASES = [
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "Notebooks vs Scripts: When to use which · Common traps"
      },
      {
    ...
    "lessons": [
      {
        ...
        "keywords": "Vectors Are Points (and Directions) · Matrices Are Transformations · The Dot Product Measures Similarity · Linear Independence · Basis and Rank · Projection · Gram-Schmidt Process · Rank, Projection, and QR with NumPy · PyTorch -- Tensors Are Vectors with Autodiff"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Transformations as matrices · Rotation · Scaling · Shearing · Reflection · Composition: chaining transformations · Eigenvalues and eigenvectors · Eigendecomposition · Why eigenvalues matter · Determinant as volume scaling factor · 3D rotations with NumPy"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The Chain Rule · Computational Graphs · Forward Mode vs Reverse Mode · Dual Numbers for Forward Mode · Building an Autograd Engine · How PyTorch Autograd Works Under the Hood · Verify against PyTorch · A more complex expression"
      },
      {
      ...
      },
      {
        ...
        "keywords": "What a tensor is · Tensor shapes in deep learning · How memory layout works · Broadcasting rules · Einsum: the universal tensor operation · Scratch vs NumPy · Scratch vs PyTorch · Every neural network layer as a tensor operation"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Graphs: Nodes and Edges · The Adjacency Matrix · Degree · BFS and DFS · The Graph Laplacian · Spectral Properties · Message Passing · Concepts and ML Applications · numpy spectral analysis"
      },
      {
        ...
        "keywords": "Random Walks · Markov Chains · Connection to Language Models · Brownian Motion · Langevin Dynamics · MCMC: Markov Chain Monte Carlo · Stochastic Processes in AI · numpy for transition matrices · Connections to real frameworks · Verifying Markov chain convergence"
      }
    ],
    "hidden": true
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "Bias: Systematic Error · Variance: Sensitivity to Training Data · The Decomposition · Model Complexity vs Error · Regularization as Bias-Variance Control · Double Descent: The Modern Perspective · Diagnosing Your Model · Practical Strategies · Ensemble Methods and Variance Reduction · Learning Curves · How to Generate Learning Curves · Validation Curve: Sweep Model Complexity · Learning Curve: Sweep Training Set Size · Cross-Validation with Regularization Sweep · Putting It All Together: A Complete Diagnostic Workflow"
      },
      {
        ...
        "keywords": "Why Ensembles Work · Bagging (Bootstrap Aggregating) · Boosting (Sequential Error Correction) · AdaBoost · Gradient Boosting · XGBoost: Why It Dominates Tabular Data · Stacking (Meta-Learning) · Voting · When to Use Each Method · The Production Stack for Tabular Data"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Types of Anomalies · The Unsupervised Framing · Supervised vs Unsupervised: The Tradeoff · Z-Score Method · IQR Method · Isolation Forest · Local Outlier Factor (LOF) · Comparison · Evaluation Challenges · Anomaly Detection Pipeline · sklearn Contamination Parameter · One-Class SVM · Autoencoder Approach (Preview) · Ensemble Anomaly Detection · Production Considerations · Choosing a Threshold · Scaling to Production"
      },
      {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "Why PyTorch Won · Tensors · Autograd · nn.Module · Loss Functions and Optimizers · The Training Loop · Dataset and DataLoader · GPU Training · Comparison: Mini Framework vs PyTorch vs JAX · Quick Comparison: Mini Framework vs PyTorch · Saving and Loading Models · Learning Rate Scheduling"
      },
      {
    ...
    "lessons": [
      {
        ...
        "keywords": "NLTK · spaCy · When to pick which · The two failure modes nobody warns you about"
      },
      {
        ...
        "keywords": "When TF-IDF still wins (as of 2026) · When TF-IDF fails · Hybrid: TF-IDF weighted embeddings"
      },
      {
        ...
        "keywords": "When Word2Vec still wins in 2026 · Where Word2Vec fails"
      },
      {
      ...
      },
      {
        ...
        "keywords": "When to reach for a transformer · The reproducibility trap (again)"
      },
      {
        ...
        "keywords": "LLM-based NER (the 2026 option) · Where classical NER still wins · Where it falls apart"
      },
      {
        ...
        "keywords": "Where this still matters in 2026"
      },
      {
      ...
      },
      {
        ...
        "keywords": "When to still reach for RNN-based seq2seq · Exposure bias and its mitigations"
      },
      {
        ...
        "keywords": "When classical attention still matters · The attention-weight-as-explanation trap"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The hard-won lessons from 2026 production RAG"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The tokenization tax (what goes wrong for low-resource languages)"
      },
      {
    ...
    "lessons": [
      {
        ...
        "keywords": "Three Approaches That Failed (and One That Won) · BPE: Byte Pair Encoding · Byte-Level BPE (GPT-2, GPT-3, GPT-4) · WordPiece (BERT) · SentencePiece (Llama, T5) · Vocabulary Size Tradeoffs · The Multilingual Tax · tiktoken (OpenAI) · Hugging Face tokenizers · Loading Llama's Tokenizer"
      },
      {
        ...
        "keywords": "The Full Pipeline · Byte-Level BPE · Pre-Tokenization · Special Tokens · Chat Templates · Speed · Comparing Real Tokenizers"
      },
      {
        ...
        "keywords": "Where the Data Comes From · Data Cleaning · Deduplication with MinHash · Sequence Packing · The Chinchilla Scaling Law · Compare With HuggingFace Datasets"
      },
      {
        ...
        "keywords": "The GPT Architecture · The Transformer Block · Attention: The Core Mechanism · KV Cache: Why Inference Is Fast · Prefill vs Decode: Two Phases of Inference · The Training Loop · GPT-2 Small: The Numbers · Full Training and Generation Demo"
      },
      {
        ...
        "keywords": "Why Distribution is Required · Data Parallelism · Tensor Parallelism · Pipeline Parallelism · FSDP: Fully Sharded Data Parallel · DeepSpeed ZeRO · Mixed Precision Training · Megatron-LM and 3D Parallelism · Run All Simulations"
      },
      {
        ...
        "keywords": "What SFT Actually Does · Data Formats · Why It Works · The Masked Loss · Training Hyperparameters · Catastrophic Forgetting · Real Numbers · Full SFT Pipeline Demo"
      },
      {
        ...
        "keywords": "The Three Stages · The Reward Model · PPO: Proximal Policy Optimization · The PPO Objective in Detail · Reward Hacking · Real RLHF Pipelines · Full RLHF Pipeline Demo"
      },
      {
        ...
        "keywords": "The Key Insight · The DPO Loss · Why DPO is Simpler · When DPO Beats RLHF · When RLHF Beats DPO · Beyond DPO: KTO, ORPO, SimPO · Real DPO Deployments · Full DPO Pipeline Demo"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The Eval Landscape · Why Benchmarks Break · Perplexity: A Quick Health Check · LLM-as-Judge · ELO Ratings from Pairwise Comparisons · Eval Frameworks · Building Custom Evals · lm-evaluation-harness (EleutherAI) · promptfoo · RAGAS for RAG evaluation"
      },
      {
        ...
        "keywords": "Number Formats: What Each Bit Does · How Quantization Works · Sensitivity Hierarchy · PTQ vs QAT · GPTQ, AWQ, GGUF · Quality Measurement · Real Numbers · Quantizing with AutoGPTQ · Quantizing with AutoAWQ · Converting to GGUF · Serving with vLLM"
      },
      {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "Zero-Shot vs Few-Shot: When Examples Beat Instructions · Example Selection: Similar Beats Random · Chain-of-Thought: Giving Models Scratch Paper · Self-Consistency: Sample Many, Vote Once · Tree-of-Thought: Branching Exploration · ReAct: Thinking + Doing · Structured Prompting: XML Tags, Delimiters, Headers · Prompt Chaining: Sequential Decomposition · Performance Comparison · With LangChain · With DSPy · Comparison: From-Scratch vs Frameworks"
      },
      {
        ...
        "keywords": "The Structured Output Spectrum · JSON Schema: The Contract Language · The Pydantic Pattern · Function Calling / Tool Use · Common Failure Modes · OpenAI Structured Outputs · Anthropic Tool Use · Instructor Library"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The Function Calling Loop · Tool Definitions: The JSON Schema Contract · Provider Comparison · Tool Choice: Auto, Required, Specific · Parallel Function Calling · Structured Outputs vs Function Calling · Security: The Non-Negotiable Rules · Error Handling · MCP: Model Context Protocol · OpenAI Function Calling · Anthropic Tool Use · MCP Integration"
      },
      {
        ...
        "keywords": "The Eval Taxonomy · LLM-as-Judge: The Workhorse · Rubric Design · The Eval Pipeline · Eval Datasets: The Foundation · Sample Size and Confidence · Regression Testing · Cost of Evals · Anti-Patterns · Real Tools · promptfoo Integration · DeepEval Integration · CI/CD Integration Pattern"
      },
      {
        ...
        "keywords": "The Cost Anatomy of an LLM Call · Provider Caching: Built-in Discounts · Semantic Caching: Your Custom Layer · Exact Caching: Hash and Match · Rate Limiting: Protecting Your Budget · Model Routing: Right Model for the Right Job · Cost Tracking: Know Where the Money Goes · Batching: Bulk Discounts · Budget Alerts and Circuit Breakers · The Optimization Stack · Anthropic Prompt Caching · OpenAI Automatic Caching · OpenAI Batch API · Production Semantic Cache with Redis"
      },
      {
        ...
        "keywords": "The Guardrail Sandwich · Attack Taxonomy · Input Guardrails · Output Guardrails · The Content Filtering Stack · Tools of the Trade · Defense-in-Depth · Real Attack Case Studies · The Honest Truth · OpenAI Moderation API · Llama Guard 4 · NeMo Guardrails · Guardrails AI"
      },
      {
        ...
        "keywords": "Production Architecture · The Stack · Streaming: Why It Matters · Error Handling: The Three Layers · Observability: What to Measure · A/B Testing Prompts in Production · Scaling · Cost Projection · The Deployment Checklist · FastAPI Server (Production Deployment) · Real API Integration · Docker Deployment"
      },
      {
      ...
      },
      {
        ...
        "summary": "A useful AI assistant is not production-ready until someone can explain what data it touches, what risks it creates, and who owns the decision when it is wrong.",
      ...
      },
      {
        ...
        "summary": "AI projects fail early when nobody can say which data is allowed, fresh, representative, and good enough for the decision.",
        "keywords": "Signals to Look For · Controls to Teach · Target Roles · Workshop Flow"
      },
      {
        ...
        "summary": "Prompt training becomes useful when people leave with reusable prompts, review habits, and a clear sense of what must be checked by a human.",
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "The Protocol Landscape · MCP (Recap) · A2A (Agent2Agent Protocol) · ACP (Agent Communication Protocol) · ANP (Agent Network Protocol) · Comparison (Corrected) · How They Work Together · Real Implementations · Picking the Right Protocol"
      },
      {
...
const ARTIFACTS = [
  ...
  },
  {
    ...
    "phase": 11,
    "lesson": 31,
    "lessonPath": "phases/11-llm-engineering/31-hands-on-prompt-clinic",
    "file": "phases/11-llm-engineering/31-hands-on-prompt-clinic/outputs/prompt-clinic-review-sheet.md"
  },
  {
    "kind": "skill",
