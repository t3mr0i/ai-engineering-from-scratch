...
window.SITE_I18N = {
  ...
  nav_site_label: { en: "Site navigation", de: "Seitennavigation" },
  ...
  learning_tools_intro: { en: "Open this tool only when you need a custom plan.", de: "Öffne dieses Werkzeug nur, wenn du einen eigenen Plan brauchst." },
  learning_tools_nav_label: { en: "Planning and evidence tools", de: "Werkzeuge für Planung und Nachweise" },
  ...
  skip_personal_plan: { en: "Skip to personal plan", de: "Zum persönlichen Plan springen" },
  personal_plan_workspace_label: { en: "Personal learning plan", de: "Persönlicher Lernplan" },
  ...
  skills_progress_intro: { en: "See how your capabilities develop as you learn and apply your knowledge.", de: "Sieh, wie sich deine Fähigkeiten durch Lernen und Anwenden entwickeln." },
  ...
  skills_page_back: { en: "Back to your learning journey", de: "Zurück zur Lernreise" },
  ...
  academy_paths_show_relevant: { en: "Show my selection", de: "Meine Auswahl anzeigen" },
  academy_group_recommended_title: { en: "Recommended for {role}", de: "Empfohlen für {role}" },
  academy_group_recommended_intro: { en: "The strongest matches for your selected profile and level.", de: "Die stärksten Treffer für dein gewähltes Profil und Level." },
  academy_group_foundation_title: { en: "Foundations for everyone", de: "Grundlagen für alle" },
  academy_group_foundation_intro: { en: "Shared knowledge and everyday tools before you specialize.", de: "Gemeinsames Wissen und Werkzeuge für den Alltag, bevor du dich spezialisierst." },
  academy_group_role_title: { en: "Role-based trainings", de: "Rollenbezogene Trainings" },
  ...
  academy_path_includes_title: { en: "This catalog route includes", de: "Diese Katalog-Lernroute enthält" },
  academy_path_format_badge: { en: "Catalog learning route", de: "Katalog-Lernroute" },
  ...
  academy_path_fact_providers: { en: "Providers", de: "Anbieter" },
  academy_path_about_title: { en: "About this catalog route", de: "Über diese Katalog-Lernroute" },
  academy_path_tracks: { en: "Tracks", de: "Tracks" },
  academy_path_journey_title: { en: "Your route", de: "Deine Lernroute" },
  academy_path_courses_title: { en: "Courses in this route", de: "Kurse dieser Lernroute" },
  academy_path_route_title: { en: "Supplementary learning route in this catalog", de: "Ergänzende Lernroute in diesem Katalog" },
  academy_path_route_intro: { en: "The courses below are this catalog's supplementary learning route. They do not replace the AI Literacy recommendations or LHIND Academy live modules. Progress here records activity in this catalog.", de: "Die folgenden Kurse bilden eine ergänzende Lernroute dieses Katalogs. Sie ersetzen weder die AI-Literacy-Empfehlungen noch die Live-Module der LHIND Academy. Der Fortschritt hier erfasst Aktivitäten in diesem Katalog." },
  academy_offering_title: { en: "Academy offering", de: "Academy-Angebot" },
  academy_offering_source_note: { en: "Local source: {source}. Check the Learning Portal for the current offer and enrollment.", de: "Lokale Quelle: {source}. Prüfe das aktuelle Angebot und die Anmeldung im Learning Portal." },
  academy_offering_modules: { en: "Courses and modules in the training overview", de: "Kurse und Module laut Trainingsübersicht" },
  academy_offering_optional: { en: "Optional", de: "Optional" },
  academy_offering_no_modules: { en: "The local sources do not establish a reliable module list for this course. Check the Learning Portal for the current modules.", de: "Aus den lokalen Quellen lässt sich für diesen Kurs keine verlässliche Modulliste ableiten. Prüfe die aktuellen Module im Learning Portal." },
  academy_recommendations_title: { en: "AI Literacy online-course recommendations", de: "Online-Kurs-Empfehlungen aus AI Literacy" },
  academy_recommendations_note: { en: "Official recommendation list, August 2026. Choose the courses for your role and level; check the source for updates.", de: "Offizielle Empfehlungsliste vom August 2026. Wähle die Kurse für deine Rolle und dein Niveau; prüfe die Quelle auf Aktualisierungen." },
  academy_recommendations_source: { en: "Open official recommendation list", de: "Offizielle Empfehlungsliste öffnen" },
  academy_recommendations_count: { en: "{count} online courses", de: "{count} Online-Kurse" },
  academy_recommendations_count_one: { en: "1 online course", de: "1 Online-Kurs" },
  academy_workshop_title: { en: "LHIND Academy live module", de: "Live-Modul der LHIND Academy" },
  academy_workshop_note: { en: "Listed in the Service Portal on 24 September 2026. Check the catalog for current dates and availability.", de: "Am 24. September 2026 im Service Portal gelistet. Prüfe dort aktuelle Termine und Verfügbarkeit." },
  academy_workshop_link: { en: "Open AI Literacy in the Service Portal", de: "AI Literacy im Service Portal öffnen" },
  ...
  key_area_tc_only: { en: "Key areas and Ausprägungen exist only for the Technology Consulting profile.", de: "Key Areas und Ausprägungen gibt es nur für das Profil Technology Consulting." },
  ...
  lrn_search_placeholder: { en: "Search by topic, for example data protection", de: "Thema suchen, zum Beispiel Datenschutz" },
  ...
  title_personal_plan: { en: "Personal Plan · LHIND AI Learning Catalog", de: "Persönlicher Plan · LHIND AI Learning Catalog" },
  ...
  course_open_first_task: { en: "Start first lesson", de: "Erste Lektion starten" },
  ...
  course_sessions_title: { en: "Upcoming dates", de: "Kommende Termine" },
  course_sessions_empty: { en: "No date has been scheduled for this course yet.", de: "Für diesen Kurs ist noch kein Termin geplant." },
  course_sessions_more: { en: "{count} further dates", de: "{count} weitere Termine" },
  course_owner_label: { en: "Course lead", de: "Kursverantwortung" },
  course_session_trainer: { en: "Trainer", de: "Trainer" },
  course_session_trainer_open: { en: "Trainer to be confirmed", de: "Trainer noch offen" },
  course_session_register: { en: "Register", de: "Anmelden" },
  course_session_seats_free: { en: "{count} seats free", de: "{count} Plätze frei" },
  course_session_seats_full: { en: "Fully booked", de: "Ausgebucht" },
  course_session_seats_open: { en: "Seats on request", de: "Plätze auf Anfrage" },
  course_lang_de: { en: "German", de: "Deutsch" },
  course_lang_en: { en: "English", de: "Englisch" },
  course_delivery_onsite: { en: "On site", de: "Präsenz" },
  course_delivery_remote: { en: "Remote", de: "Remote" },
  course_delivery_hybrid: { en: "Hybrid", de: "Hybrid" },
  course_session_status_planned: { en: "Planned", de: "Geplant" },
  course_session_status_confirmed: { en: "Confirmed", de: "Bestätigt" },
  course_session_status_full: { en: "Fully booked", de: "Ausgebucht" },
  course_session_status_cancelled: { en: "Cancelled", de: "Abgesagt" },
  course_session_status_done: { en: "Completed", de: "Durchgeführt" },
  course_card_next_date: { en: "Next date {date}", de: "Nächster Termin {date}" },
  lrn_status_scheduled: { en: "With date", de: "Mit Termin" },
  ...
  course_learning_contract_label: { en: "Optional practice", de: "Optionale Übung" },
  course_learning_contract_title: { en: "Apply the course content", de: "Kursinhalt in der Praxis erproben" },
  course_learning_contract_note: { en: "Suggested by this catalog; this is not a Learning Portal completion requirement.", de: "Vorschlag aus diesem Katalog; keine Abschlussanforderung des Learning Portals." },
  course_project_scenario_title: { en: "Practice scenario", de: "Übungsbeispiel" },
  course_learning_method_title: { en: "Suggested steps", de: "Mögliche Schritte" },
  course_completion_evidence_title: { en: "Possible work samples", de: "Mögliche Arbeitsergebnisse" },
  course_card_outcome_label: { en: "You will be able to", de: "Danach kannst du" },
  course_card_lesson_one: { en: "1 lesson", de: "1 Lektion" },
  course_card_lessons_many: { en: "{count} lessons", de: "{count} Lektionen" },
  course_more_details: { en: "More about this course", de: "Mehr zu diesem Kurs" },
  course_card_learning_mix: { en: "Theory · worked examples · hands-on", de: "Theorie · Praxisbeispiele · Hands-on" },
  course_default_contract_promise: { en: "Complete this course with a concrete, reviewable result that demonstrates one published course outcome and transfers to your work.", de: "Schließe diesen Kurs mit einem konkreten, überprüfbaren Ergebnis ab, das eine ausgewiesene Kurskompetenz nachweist und auf deine Arbeit übertragbar ist." },
  course_default_project_title: { en: "Transfer one sanitized case from your work", de: "Übertrage einen bereinigten Fall aus deiner Arbeit" },
  course_default_project_description: { en: "Apply one course method to an anonymized project case. Keep the original problem, constraints, acceptance criteria, and responsible owner visible so another person can review the result in context.", de: "Wende eine Kursmethode auf einen anonymisierten Projektfall an. Halte Ausgangsproblem, Rahmenbedingungen, Akzeptanzkriterien und verantwortliche Person sichtbar, damit das Ergebnis im Kontext geprüft werden kann." },
  course_default_project_guardrail: { en: "Use approved tools and anonymized inputs only; remove secrets, personal data, customer identifiers, and restricted project material before starting.", de: "Nutze ausschließlich freigegebene Tools und anonymisierte Eingaben; entferne vor dem Start Geheimnisse, personenbezogene Daten, Kundenkennungen und eingeschränktes Projektmaterial." },
  course_default_theory_title: { en: "Build the foundation", de: "Grundlage aufbauen" },
  course_default_theory_description: { en: "{count} curriculum units explain the concepts, constraints, and technical background before application.", de: "{count} Kurseinheiten erklären Konzepte, Rahmenbedingungen und technische Hintergründe vor der Anwendung." },
  course_default_guided_title: { en: "Trace worked cases", de: "Praxisfälle nachvollziehen" },
  course_default_guided_description: { en: "{count} mapped lessons connect the concepts to concrete examples, implementation paths, and review decisions.", de: "{count} zugeordnete Lektionen verbinden die Konzepte mit konkreten Beispielen, Umsetzungswegen und Review-Entscheidungen." },
  course_default_hands_on_title: { en: "Apply and verify", de: "Anwenden und überprüfen" },
  course_default_hands_on_description: { en: "Run the lesson demos and exercises, inspect the reusable artifacts, and check the result against tests or an explicit review rubric.", de: "Führe die Demos und Übungen aus, prüfe die wiederverwendbaren Artefakte und gleiche das Ergebnis mit Tests oder einer expliziten Review-Rubrik ab." },
  course_default_evidence_outcome: { en: "A result that demonstrates one of the published course outcomes", de: "Ein Ergebnis, das eine der ausgewiesenen Kurskompetenzen nachweist" },
  course_default_evidence_case: { en: "Worked-case notes that identify assumptions, constraints, and trade-offs", de: "Notizen zu einem Praxisfall mit Annahmen, Rahmenbedingungen und Abwägungen" },
  course_default_evidence_artifact: { en: "A completed hands-on exercise, runnable artifact, or project worksheet", de: "Eine abgeschlossene Hands-on-Übung, ein ausführbares Artefakt oder ein Projektarbeitsblatt" },
  course_default_evidence_verification: { en: "Verification evidence such as tests, quiz results, source checks, or review notes", de: "Prüfnachweise wie Tests, Quiz-Ergebnisse, Quellenprüfungen oder Review-Notizen" },
  course_default_evidence_transfer: { en: "A short transfer note for one anonymized project case, including the next action and responsible owner", de: "Eine kurze Transfernotiz zu einem anonymisierten Projektfall einschließlich nächster Aktion und verantwortlicher Person" },
  lesson_outcomes_title: { en: "After this lesson, you can", de: "Nach dieser Lektion kannst du" },
  lesson_outcomes_intro: { en: "Use these outcomes as the checklist for your exercise and final evidence.", de: "Nutze diese Ergebnisse als Checkliste für deine Übung und deinen Abschlussnachweis." },
  course_tasks_title: { en: "Tasks", de: "Aufgaben" },
  course_path_title: { en: "Your learning steps", de: "Deine Lernschritte" },
  course_path_intro: { en: "Start with the first lesson. Open a unit to see the lessons inside.", de: "Beginne mit der ersten Lektion. Öffne eine Einheit, um ihre Lektionen zu sehen." },
  course_path_unit_one: { en: "1 unit", de: "1 Einheit" },
  course_path_units_many: { en: "{count} units", de: "{count} Einheiten" },
  course_path_activity_one: { en: "1 activity", de: "1 Aktivität" },
  course_path_activities_many: { en: "{count} activities", de: "{count} Aktivitäten" },
  course_unit_next: { en: "Next up", de: "Als Nächstes" },
  course_unit_complete: { en: "Complete", de: "Abgeschlossen" },
  ...
  artifact_ready: { en: "Open the preview to load this file.", de: "Öffne die Vorschau, um diese Datei zu laden." },
  artifact_loading: { en: "Loading file…", de: "Datei wird geladen…" },
  artifact_error: { en: "This file could not be loaded inside the application.", de: "Diese Datei konnte innerhalb der Anwendung nicht geladen werden." },
  artifact_copy: { en: "Copy file", de: "Datei kopieren" },
  artifact_copied: { en: "Copied", de: "Kopiert" },
