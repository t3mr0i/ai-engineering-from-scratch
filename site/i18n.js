...
window.SITE_I18N = {
  ...
  learning_tool_team_open: { en: "Open team learning", de: "Teamlernen öffnen" },
  ...
  team_learning_page_title: { en: "Team learning", de: "Teamlernen" },
  team_learning_page_intro: { en: "Join assigned learning, follow shared course priorities, and turn quiz results into verifiable evidence.", de: "Tritt zugewiesenem Lernen bei, folge gemeinsamen Kursprioritäten und mache Quiz-Ergebnisse als Nachweise sichtbar." },
  skip_personal_plan: { en: "Skip to personal plan", de: "Zum persönlichen Plan springen" },
  skip_team_learning: { en: "Skip to team learning", de: "Zum Teamlernen springen" },
  personal_plan_workspace_label: { en: "Personal learning plan", de: "Persönlicher Lernplan" },
  team_learning_workspace_label: { en: "Team learning and skill evidence", de: "Teamlernen und Kompetenznachweise" },
  ...
  title_team_learning: { en: "Team Learning · LHIND AI Learning Catalog", de: "Teamlernen · LHIND AI Learning Catalog" },
  ...
  course_learning_contract_label: { en: "Learning contract", de: "Lernversprechen" },
  course_learning_contract_title: { en: "From concept to project evidence", de: "Vom Konzept zum Projektnachweis" },
  course_project_scenario_title: { en: "Project scenario", de: "Projektszenario" },
  course_learning_method_title: { en: "How you learn", de: "So lernst du" },
  course_completion_evidence_title: { en: "Evidence of completion", de: "Abschlussnachweise" },
