# Entry point for phases/01-math-foundations/16-sampling-methods/docs/en.md.
# Delegates to the original sampling.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("sampling.py")), run_name="__main__")
