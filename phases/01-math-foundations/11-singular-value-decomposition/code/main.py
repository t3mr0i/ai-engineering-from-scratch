# Entry point for phases/01-math-foundations/11-singular-value-decomposition/docs/en.md.
# Delegates to the original svd.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("svd.py")), run_name="__main__")
