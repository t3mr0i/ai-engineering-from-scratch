# Entry point for phases/01-math-foundations/02-vectors-matrices-operations/docs/en.md.
# Delegates to the original matrices.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("matrices.py")), run_name="__main__")
