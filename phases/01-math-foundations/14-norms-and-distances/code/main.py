# Entry point for phases/01-math-foundations/14-norms-and-distances/docs/en.md.
# Delegates to the original distances.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("distances.py")), run_name="__main__")
