# Entry point for phases/01-math-foundations/13-numerical-stability/docs/en.md.
# Delegates to the original numerical.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("numerical.py")), run_name="__main__")
