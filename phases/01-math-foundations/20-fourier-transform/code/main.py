# Entry point for phases/01-math-foundations/20-fourier-transform/docs/en.md.
# Delegates to the original fourier.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("fourier.py")), run_name="__main__")
