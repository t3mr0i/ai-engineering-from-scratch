# Entry point for phases/01-math-foundations/07-bayes-theorem/docs/en.md.
# Delegates to the original bayes.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("bayes.py")), run_name="__main__")
