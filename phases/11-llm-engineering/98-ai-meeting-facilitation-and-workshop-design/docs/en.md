...
Running this as a two-agent loop surfaces gaps that a single extraction pass misses, at the cost of one extra model call per meeting — justified for any meeting whose output feeds external stakeholders.
...
- [ISO 9001:2015 — Clause 6.1 Actions to address risks and opportunities](https://www.iso.org/standard/62085.html) — the standard that formalises decision documentation requirements in quality management systems; useful when meeting artifacts feed regulated processes.
