...
class CourseArtifactTests(unittest.TestCase):
    def test_signal_matching_finds_known_signal(self):
        scenario = Scenario("pilot", "there is a recurring question", ("recurring question",), impact=3, uncertainty=2)
        self.assertIn("recurring question", signal_matches(scenario))
    ...
    def test_recommendation_contains_controls(self):
        scenario = Scenario("controlled", "team blocker", ("team blocker",), impact=4, uncertainty=4)
    ...
    def test_build_plan_sorts_by_score_descending(self):
        scenarios = [
            ...
            Scenario("large", "recurring question", ("recurring question",), impact=5, uncertainty=5),
        ]
