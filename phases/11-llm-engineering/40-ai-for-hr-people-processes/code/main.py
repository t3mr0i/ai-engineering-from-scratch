"""AI for HR and People Processes course artifact.

Lesson docs: phases/11-llm-engineering/40-ai-for-hr-people-processes/docs/en.md
...
SIGNALS = ["personal data", "fairness risk", "employee impact", "manager decision"]
CONTROLS = ["privacy review", "fairness check", "human decision owner", "communication script"]
CATEGORIES = ["privacy", "fairness", "trust", "accountability"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("feedback summary", "Personal data with employee impact and manager decision.", ("personal data", "employee impact", "manager decision"), 5, 4),
        Scenario("learning path assistant", "Fairness risk in development recommendations.", ("fairness risk",), 3, 3),
        Scenario("policy rewrite", "Low-risk drafting of public internal guidance.", (), 2, 2),
    ]
