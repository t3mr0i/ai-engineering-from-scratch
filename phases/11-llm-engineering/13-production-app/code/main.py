# Entry point for phases/11-llm-engineering/13-production-app/docs/en.md.
# Delegates to the original production_app.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("production_app.py")), run_name="__main__")
