"""AI Use Case Spotting and Automation Discovery course artifact.

Lesson docs: phases/11-llm-engineering/24-use-case-spotting-automation-discovery/docs/en.md
...
SIGNALS = ["repeatable workflow", "text-heavy input", "measurable pain", "clear owner"]
CONTROLS = ["pilot metric", "risk review", "data readiness check", "owner signoff"]
CATEGORIES = ["assist", "automate", "retrieve", "predict"]
