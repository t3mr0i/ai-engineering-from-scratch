...
## CBP context: impact before tools and training

In the CBP context change analysis maps affected roles, stakeholder needs, communication gaps, and manager dependencies before any rollout scales — tools and training follow impact, not the reverse. Managers must explain expectations in their own words; stakeholders must see their work in the change. Adoption without impact mapping is installation, not change.
