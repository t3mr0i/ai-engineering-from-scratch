"""AI for Legal, Procurement, and Compliance course artifact.

Lesson docs: phases/11-llm-engineering/42-ai-for-legal-procurement-compliance/docs/en.md
...
SIGNALS = ["confidential term", "obligation risk", "vendor clause", "missing evidence"]
CONTROLS = ["confidentiality check", "clause register", "legal reviewer", "decision record"]
CATEGORIES = ["confidentiality", "obligation", "vendor", "evidence"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("vendor terms review", "Vendor clause with obligation risk and missing evidence.", ("vendor clause", "obligation risk", "missing evidence"), 5, 4),
        Scenario("policy summary", "Confidential term appears in source material.", ("confidential term",), 4, 3),
        Scenario("public FAQ", "Low-risk wording support for public policy guidance.", (), 2, 2),
    ]
