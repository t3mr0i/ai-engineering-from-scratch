"""AI-Driven Testing and QA course artifact.

Lesson docs: phases/11-llm-engineering/19-ai-driven-testing-qa/docs/en.md
...
SIGNALS = ["state transition", "money impact", "date logic", "external dependency"]
CONTROLS = ["property tests", "golden cases", "regression suite", "manual exploratory pass"]
CATEGORIES = ["unit", "integration", "regression", "exploratory"]
