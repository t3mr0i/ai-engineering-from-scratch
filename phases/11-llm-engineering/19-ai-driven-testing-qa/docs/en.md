...
In the lab you build a QA planner that turns user stories and risk signals into prioritized test cases. It assigns test type, oracle, severity, and release gate so generated tests map to product risk.
...
```bash
cd phases/11-llm-engineering/19-ai-driven-testing-qa/code
python3 main.py
