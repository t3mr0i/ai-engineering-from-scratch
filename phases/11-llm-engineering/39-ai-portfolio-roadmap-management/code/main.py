"""AI Portfolio and Roadmap Management course artifact.

Lesson docs: phases/11-llm-engineering/39-ai-portfolio-roadmap-management/docs/en.md
...
SIGNALS = ["unclear owner", "dependency risk", "capacity conflict", "weak metric"]
CONTROLS = ["portfolio board", "review cadence", "kill criteria", "scaling decision"]
CATEGORIES = ["ownership", "dependency", "capacity", "evidence"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("multi-team rollout", "Capacity conflict with dependency risk and weak metric.", ("capacity conflict", "dependency risk", "weak metric"), 5, 4),
        Scenario("innovation backlog", "Several ideas have unclear owner and weak metric.", ("unclear owner", "weak metric"), 4, 3),
        Scenario("small pilot", "Single team pilot with clear owner.", (), 2, 2),
    ]
