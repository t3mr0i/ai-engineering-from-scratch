"""AI Operations and Incident Response course artifact.

Lesson docs: phases/11-llm-engineering/38-ai-operations-incident-response/docs/en.md
...
SIGNALS = ["quality drift", "cost spike", "tool failure", "safety alert"]
CONTROLS = ["runbook", "rollback path", "escalation owner", "postmortem"]
CATEGORIES = ["quality", "cost", "tooling", "safety"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("production assistant", "Cost spike and quality drift after release.", ("cost spike", "quality drift"), 5, 4),
        Scenario("workflow tool outage", "Tool failure and safety alert during operation.", ("tool failure", "safety alert"), 4, 4),
        Scenario("pilot review", "Small pilot with manual support coverage.", (), 2, 2),
    ]
