"""Consultative Prompting course artifact.

Lesson docs: phases/11-llm-engineering/26-consultative-prompting/docs/en.md
...
SIGNALS = ["unclear decision", "stakeholder tension", "weak hypothesis", "missing constraint"]
CONTROLS = ["assumption check", "counterargument", "audience fit", "source grounding"]
CATEGORIES = ["discover", "structure", "challenge", "synthesize"]
