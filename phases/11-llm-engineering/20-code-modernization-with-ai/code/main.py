"""Code Modernization with AI course artifact.

Lesson docs: phases/11-llm-engineering/20-code-modernization-with-ai/docs/en.md
...
TITLE = "Code Modernization with AI"
CAPABILITY = "Engineering - AI-Supported Code Modernization"
SIGNALS = ["low tests", "high coupling", "stale dependency", "production incident"]
CONTROLS = ["characterization tests", "small PRs", "rollback plan", "owner review"]
CATEGORIES = ["understand", "protect", "slice", "replace"]
