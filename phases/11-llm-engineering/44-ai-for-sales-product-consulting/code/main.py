"""AI for Sales and Product Consulting course artifact.

Lesson docs: phases/11-llm-engineering/44-ai-for-sales-product-consulting/docs/en.md
...
SIGNALS = ["customer signal", "value hypothesis", "proposal risk", "follow up gap"]
CONTROLS = ["source check", "value story", "stakeholder review", "follow up plan"]
CATEGORIES = ["customer", "value", "proposal", "follow-up"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("proposal draft", "Proposal risk with weak customer signal and untested value hypothesis.", ("proposal risk", "customer signal", "value hypothesis"), 5, 4),
        Scenario("discovery prep", "Follow up gap after product consulting conversation.", ("follow up gap",), 3, 3),
        Scenario("internal notes", "Low-risk summary for product team context.", (), 2, 2),
    ]
