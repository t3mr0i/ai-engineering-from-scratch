"""Internal Knowledge Assistants with RAG course artifact.

Lesson docs: phases/11-llm-engineering/36-internal-knowledge-assistants-rag/docs/en.md
...
SIGNALS = ["source sprawl", "stale content", "permission risk", "no evaluation set"]
CONTROLS = ["source owner", "freshness rule", "access boundary", "answer evaluation"]
CATEGORIES = ["source", "freshness", "access", "quality"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("service knowledge bot", "Source sprawl with stale content and permission risk.", ("source sprawl", "stale content", "permission risk"), 4, 4),
        Scenario("policy assistant", "No evaluation set for sensitive HR answers.", ("no evaluation set", "permission risk"), 4, 3),
        Scenario("team FAQ", "Small source owner group with clear documents.", (), 2, 2),
    ]
