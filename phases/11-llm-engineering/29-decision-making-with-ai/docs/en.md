...
In the lab you build a decision memo generator. It turns a decision brief into options, assumptions, evidence gaps, scenarios, risks, and a human-in-the-loop review plan.
...
```bash
cd phases/11-llm-engineering/29-decision-making-with-ai/code
python3 main.py
