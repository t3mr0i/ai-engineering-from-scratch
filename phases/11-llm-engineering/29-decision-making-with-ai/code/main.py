"""Decision Making with AI course artifact.

Lesson docs: phases/11-llm-engineering/29-decision-making-with-ai/docs/en.md
...
SIGNALS = ["high uncertainty", "irreversible decision", "stakeholder conflict", "missing evidence"]
CONTROLS = ["decision owner", "confidence threshold", "scenario review", "evidence gap log"]
CATEGORIES = ["frame", "compare", "stress-test", "decide"]
