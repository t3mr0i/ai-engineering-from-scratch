"""AI-Assisted Documentation course artifact.

Lesson docs: phases/11-llm-engineering/21-ai-assisted-documentation/docs/en.md
...
SIGNALS = ["missing owner", "no source link", "stale date", "no verification step"]
CONTROLS = ["source citation", "owner approval", "review cadence", "command validation"]
CATEGORIES = ["runbook", "adr", "api-doc", "release-note"]
