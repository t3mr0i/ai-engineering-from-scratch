"""AI Use Case Identification Workshop course artifact.

Lesson docs: phases/11-llm-engineering/32-ai-use-case-identification-workshop/docs/en.md
...
SIGNALS = ["manual work", "high volume", "process variance", "handoff delay"]
CONTROLS = ["use case canvas", "value risk score", "pilot metric", "accountable owner"]
CATEGORIES = ["efficiency", "quality", "risk", "experience"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("invoice intake", "High volume manual work with process variance.", ("high volume", "manual work", "process variance"), 4, 3),
        Scenario("handoff assistant", "Repeated handoff delay between teams.", ("handoff delay",), 3, 3),
        Scenario("one-off report", "Low-volume exploration idea.", (), 2, 2),
    ]
