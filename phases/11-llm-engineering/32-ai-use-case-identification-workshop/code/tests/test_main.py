...
class CourseArtifactTests(unittest.TestCase):
    def test_signal_matching_finds_known_signal(self):
        scenario = Scenario("pilot", "workflow has manual work", ("manual work",), impact=3, uncertainty=2)
        self.assertIn("manual work", signal_matches(scenario))
    ...
    def test_build_plan_sorts_by_score_descending(self):
        scenarios = [
            ...
            Scenario("large", "manual work", ("manual work",), impact=5, uncertainty=5),
        ]
