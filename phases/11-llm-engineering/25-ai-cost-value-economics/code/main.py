"""AI Cost and Value Economics course artifact.

Lesson docs: phases/11-llm-engineering/25-ai-cost-value-economics/docs/en.md
...
SIGNALS = ["token volume", "license cost", "review effort", "adoption rate"]
CONTROLS = ["baseline metric", "assumption log", "sensitivity range", "benefits owner"]
CATEGORIES = ["cost", "benefit", "risk", "adoption"]
