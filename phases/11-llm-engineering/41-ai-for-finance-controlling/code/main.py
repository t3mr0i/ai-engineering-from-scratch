"""AI for Finance and Controlling course artifact.

Lesson docs: phases/11-llm-engineering/41-ai-for-finance-controlling/docs/en.md
...
SIGNALS = ["source mismatch", "forecast uncertainty", "approval risk", "variance gap"]
CONTROLS = ["source trace", "assumption log", "variance check", "approval owner"]
CATEGORIES = ["source", "forecast", "approval", "variance"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("monthly commentary", "Variance gap with source mismatch before management reporting.", ("variance gap", "source mismatch"), 4, 4),
        Scenario("forecast brief", "Forecast uncertainty and approval risk before leadership review.", ("forecast uncertainty", "approval risk"), 5, 3),
        Scenario("team draft", "Low-risk wording support for an already approved report.", (), 2, 2),
    ]
