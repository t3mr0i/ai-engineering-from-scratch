"""AI Vendor and Procurement Evaluation course artifact.

Lesson docs: phases/11-llm-engineering/37-ai-vendor-procurement-evaluation/docs/en.md
...
SIGNALS = ["data residency", "security evidence", "lock in", "unclear pricing"]
CONTROLS = ["vendor scorecard", "trial criteria", "exit plan", "approval record"]
CATEGORIES = ["data", "security", "commercial", "integration"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("enterprise assistant vendor", "Unclear pricing with lock in and missing security evidence.", ("unclear pricing", "lock in", "security evidence"), 4, 4),
        Scenario("analytics tool", "Data residency must be checked before a paid trial.", ("data residency",), 3, 3),
        Scenario("sandbox tool", "Low-risk internal trial with no customer data.", (), 2, 2),
    ]
