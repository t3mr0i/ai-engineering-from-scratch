...
In the lab you build a small risk triage engine. It classifies use cases by data sensitivity, autonomy, external impact, and explanation need. The artifact produces a control plan: allowed mode, required reviewers, logging level, and launch gate.
...
```bash
cd phases/11-llm-engineering/18-responsible-ai-compliance-workflow/code
python3 main.py
