"""Sustainable Software and Green Coding for AI Systems course artifact.

Lesson docs: phases/11-llm-engineering/22-sustainable-software-green-coding/docs/en.md
...
TITLE = "Sustainable Software and Green Coding for AI Systems"
CAPABILITY = "Engineering - Sustainable Software & Green Coding"
SIGNALS = ["high volume", "repeatable request", "low risk", "large context"]
CONTROLS = ["caching", "batching", "small model fallback", "token budget"]
CATEGORIES = ["rules", "small-model", "large-model", "human-review"]
