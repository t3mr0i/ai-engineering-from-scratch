...
class CourseArtifactTests(unittest.TestCase):
    def test_signal_matching_finds_known_signal(self):
        scenario = Scenario("pilot", "workflow includes data residency", ("data residency",), impact=3, uncertainty=2)
    ...
    def test_recommendation_contains_controls(self):
        scenario = Scenario("controlled", "data residency", ("data residency",), impact=4, uncertainty=4)
    ...
    def test_build_plan_sorts_by_score_descending(self):
        scenarios = [
            ...
            Scenario("large", "data residency", ("data residency",), impact=5, uncertainty=5),
        ]
