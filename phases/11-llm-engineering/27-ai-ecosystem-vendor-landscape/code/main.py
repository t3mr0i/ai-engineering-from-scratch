"""AI Ecosystem and Vendor Landscape course artifact.

Lesson docs: phases/11-llm-engineering/27-ai-ecosystem-vendor-landscape/docs/en.md
...
SIGNALS = ["data residency", "integration need", "governance requirement", "lock-in risk"]
CONTROLS = ["evaluation criteria", "pilot test", "exit plan", "security review"]
CATEGORIES = ["model", "platform", "orchestration", "application"]
