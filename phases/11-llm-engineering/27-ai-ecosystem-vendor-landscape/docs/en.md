...
In the lab you build a vendor decision matrix. It classifies tools by layer, maps capabilities to requirements, and scores fit, integration effort, governance, data constraints, and exit risk.
...
```bash
cd phases/11-llm-engineering/27-ai-ecosystem-vendor-landscape/code
python3 main.py
