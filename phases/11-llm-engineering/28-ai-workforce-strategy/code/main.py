"""AI Workforce Strategy course artifact.

Lesson docs: phases/11-llm-engineering/28-ai-workforce-strategy/docs/en.md
...
SIGNALS = ["high frequency task", "skill gap", "manager dependency", "adoption blocker"]
CONTROLS = ["role expectation", "champion network", "training path", "adoption metric"]
CATEGORIES = ["assist", "automate", "redesign", "protect"]
