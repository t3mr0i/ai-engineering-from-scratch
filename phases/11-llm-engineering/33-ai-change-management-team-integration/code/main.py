"""AI Change Management and Team Integration course artifact.

Lesson docs: phases/11-llm-engineering/33-ai-change-management-team-integration/docs/en.md
...
SIGNALS = ["role impact", "adoption friction", "governance gap", "process handoff"]
CONTROLS = ["role map", "stakeholder plan", "training path", "adoption metric"]
CATEGORIES = ["roles", "adoption", "governance", "handoff"]
...
def demo_scenarios() -> list[Scenario]:
    return [
        Scenario("rollout to service team", "High role impact with adoption friction and process handoff.", ("role impact", "adoption friction", "process handoff"), 4, 4),
        Scenario("policy update", "Governance gap before team adoption.", ("governance gap",), 3, 3),
        Scenario("brown bag", "Low-risk awareness session for one team.", (), 2, 2),
    ]
