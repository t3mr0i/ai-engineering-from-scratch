...
class CourseArtifactTests(unittest.TestCase):
    def test_signal_matching_finds_known_signal(self):
        scenario = Scenario("pilot", "workflow has role impact", ("role impact",), impact=3, uncertainty=2)
    ...
    def test_recommendation_contains_controls(self):
        scenario = Scenario("controlled", "governance gap", ("governance gap",), impact=4, uncertainty=4)
    ...
    def test_build_plan_sorts_by_score_descending(self):
        scenarios = [
            ...
            Scenario("large", "role impact", ("role impact",), impact=5, uncertainty=5),
        ]
