# Entry point for phases/02-ml-fundamentals/14-naive-bayes/docs/en.md.
# Delegates to the original naive_bayes.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("naive_bayes.py")), run_name="__main__")
