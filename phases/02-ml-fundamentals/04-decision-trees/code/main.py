# Entry point for phases/02-ml-fundamentals/04-decision-trees/docs/en.md.
# Delegates to the original trees.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("trees.py")), run_name="__main__")
