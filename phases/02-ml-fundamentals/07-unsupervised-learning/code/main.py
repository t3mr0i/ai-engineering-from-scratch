# Entry point for phases/02-ml-fundamentals/07-unsupervised-learning/docs/en.md.
# Delegates to the original clustering.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("clustering.py")), run_name="__main__")
