# Entry point for phases/02-ml-fundamentals/15-time-series/docs/en.md.
# Delegates to the original time_series.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("time_series.py")), run_name="__main__")
