# Entry point for phases/02-ml-fundamentals/06-knn-and-distances/docs/en.md.
# Delegates to the original knn.py lesson implementation.
...
runpy.run_path(str(Path(__file__).with_name("knn.py")), run_name="__main__")
